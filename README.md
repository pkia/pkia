...
- [pi-cicd](https://github.com/pkia/pi-cicd) — the CI/CD pattern behind it all: health checks, auto-rollback, dead-man's switches
- [radar](https://github.com/pkia/radar) — idea ledger an overnight agent loop works through
