...
day — latest, borg backups with a weekly restore drill that byte-compares
the recovery, on top of an ntfy notification backbone and a dead-man's
switch watching the loop itself.

**Repos**

- [pi-cicd](https://github.com/pkia/pi-cicd) — the CI/CD pattern behind it all: health checks, auto-rollback, dead-man's switches, ntfy alerts, borg backups + restore drills
